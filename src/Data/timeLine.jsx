export const timeLineDeskData = [
  {
    id: 1,
    headOne: "Hackathon Announcement",
    headTwo: "Teams Registration begins",
    bodyOne:
  ...
  {
    id: 2,
    headOne: "Teams Registration ends",
    headTwo: "Announcement of the accepted teams and ideas",
    bodyOne: "Interested Participants are no longer Allowed to register",
    bodyTwo:
  ...
  {
    id: 3,
    headOne: "Getlinked Hackathon 1.0 Offically Begins",
    headTwo: "Demo Day",
    bodyOne:
...
export const timeLineMobileData = [
  {
    id: 1,
    head: "Hackathon Announcement",
